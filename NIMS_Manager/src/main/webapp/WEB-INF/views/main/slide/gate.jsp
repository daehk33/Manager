<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="slide-container" role="gate">
	<p class="slide-title">
		출입게이트
	</p>
	<div class="row">
		<div class="col-xl-5">
			<div class="row row-card-no-pd book-status-container">
				<div class="col-xl-6 col-sm-6">
					<div class="card card-stats card-round" data-card="gate-total-pass">
						<div class="card-body">
				...
				<div class="col-xl-6 col-sm-6">
					<div class="card card-stats card-round" data-card="gate-total-user">
						<div class="card-body">
							<div class="row align-items-center justify-content-center">
								<div class="col-icon">
...
<script type="text/javascript" src="/resources/js/main/slide/gate.js"></script>