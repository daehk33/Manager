<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="slide-container" role="sls">
	<p class="slide-title">
		스마트 도서관
	</p>
	<div class="row">
		<div class="col-xl-5">
			<div class="row row-card-no-pd book-status-container">
				<div class="col-xl-4 col-sm-4">
					<div class="card card-stats card-round" data-card="book-status-total">
						<div class="card-body">
				...
				<div class="col-xl-4 col-sm-4">
					<div class="card card-stats card-round" data-card="book-status-loanable">
						<div class="card-body">
							<div class="row align-items-center justify-content-center">
								<div class="col-icon">
				...
				<div class="col-xl-4 col-sm-4">
					<div class="card card-stats card-round" data-card="book-status-loan">
						<div class="card-body">
							<div class="row align-items-center justify-content-center">
								<div class="col-icon">
...
<script type="text/javascript" src="/resources/js/main/slide/sls.js"></script>