<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="slide-container" role="loanReturn">
	<p class="slide-title">
		대출반납기
	</p>
	<div class="row">
		<div class="col-xl-5">
			<div class="row row-card-no-pd book-status-container">
				<div class="col-xl-6 col-sm-6">
					<div class="card card-stats card-round" data-card="loanReturn-total-loan">
						<div class="card-body">
				...
				<div class="col-xl-6 col-sm-6">
					<div class="card card-stats card-round" data-card="loanReturn-total-return">
						<div class="card-body">
							<div class="row align-items-center justify-content-center">
								<div class="col-icon">
				...
				<div class="col-xl-12">
					<div class="card">
						...
						<div class="card-body card-body-event-status">
							<div class="row" id="chartEventStatus" role="list"></div>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="/resources/js/main/slide/loanReturn.js"></script>