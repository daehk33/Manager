			...
			<div class="modal-body">
				<div class="container-fluid ta-l">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="com" class="placeholder">포트번호</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
						...
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="value4" class="placeholder">항목 4</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="value5" class="placeholder">항목 5</label>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/resources/js/main/loanReturn/modal/equipSettingModal.js"></script>
