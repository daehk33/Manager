			...
			<div class="modal-body">
				<div class="container-fluid ta-l">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group form-floating-label">
								...
								<label for="rule_id" class="placeholder">정책 아이디</label>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<input type="text" class="form-control input-border-bottom item-field" id="rule_name" required="">
								<label for="rule_name" class="placeholder">정책 내용</label>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="option01" class="placeholder">항목 1</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="option02" class="placeholder">항목 2</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="option03" class="placeholder">항목 3</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="option04" class="placeholder">항목 4</label>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/resources/js/main/gate/modal/ruleSettingModal.js"></script>
