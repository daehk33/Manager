			...
			<div class="modal-body">
				<div class="container-fluid ta-l">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group form-floating-label">
								<input type="text" class="form-control input-border-bottom item-field" id="id" required="">
								<label for="id" class="placeholder">정책 번호</label>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group form-floating-label">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="opt01" class="placeholder">항목 1</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="opt02" class="placeholder">항목 2</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="opt03" class="placeholder">항목 3</label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-floating-label">
								<label for="opt04" class="placeholder">항목 4</label>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/resources/js/main/sls/modal/ruleSettingModal.js"></script>
