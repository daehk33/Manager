$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					},
					{
						...
						columns: [
							{ title: "반납 횟수", field: "cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false, topCalc: "sum" },
							{ title: "이용자 수 ", field: "user_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					}
				],
					...
					ajaxResponse : function(url, params, response) {
						...
						Object.entries(libraryInfo).forEach(info => {
							...
							info[1].forEach(library => {
								...
								col.return_info[1].push(library.user_cnt);
							});
	...
	Content.load({
		url: '/api/stats/getStatsUnmannedReturnTime'
	});
});