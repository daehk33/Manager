$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					},
					{
						...
						columns:[
							{ title: "건수", field: "cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center", topCalc:"sum" },
							{ title: "이용자 수", field: "user_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center" },
						]
					}
				],
	...
	Content.load({
		url: '/api/stats/getStatsUnmannedReturnDate'
	});
});