$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					{ title: "장비명", field: "device_nm", widthGrow: 3, hozAlign: "center", headerHozAlign: "center", headerSort: false },
					{
						...
						columns: [
							{ title: "반납 횟수", field: "cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
							{ title: "이용자 수 ", field: "user_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					}
				],
	...
	Content.load({
		url: '/api/stats/getStatsUnmannedReturnDevice'
	});
});