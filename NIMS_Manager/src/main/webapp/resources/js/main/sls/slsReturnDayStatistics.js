$(function() {
	const Content = {
		...
		event: function(){
			...
			$('button[role="export"]').click(function(e){
				...
				if(Search.params.type != "all") file_name = "기간별 무인 반납 통계_("+Search.params.startDate+").xlsx";
				else file_name = "기간별 무인 반납 통계_("+Search.params.startDate+"-"+Search.params.endDate+").xlsx";
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					},
					{
						...
						columns:[
							{ title: "건수", field: "cnt", headerSort: false, hozAlign: "center", headerHozAlign: "center", topCalc:"sum" },
							{ title: "이용자 수", field: "user_cnt", headerSort: false, hozAlign: "center", headerHozAlign: "center" },
						]
					},
				],
	...
	Content.load({
		url: '/api/stats/getStatsUnmannedReturnList'
	});
});