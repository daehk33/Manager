$(function() {
	...
	const UseStatsTable = {
		...
		draw : function () {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					{
						title: "시간", 	field: "log_time", widthGrow: 2, hozAlign: "center", headerHozAlign: "center", headerSort: false, topCalc:() => "합계",
					...
					},
					{
						...
						columns: [
							{ title: "대출 횟수", field: "loan_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false, topCalc: "sum" },
							{ title: "이용자 수 ", field: "loan_user_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					},
					{
						title: "반납 정보", hozAlign: "center", headerHozAlign: "center",
						columns: [
							{ title: "반납 횟수", field: "return_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false, topCalc: "sum" },
							{ title: "이용자 수 ", field: "return_user_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					}
				],
				...
				ajaxResponse : function(url, params, response) {
					...
					Object.entries(libraryInfo).forEach(info => {
						...
						info[1].forEach(library => {
							...
							col.return_info[1].push(library.return_user_cnt);
						});
	...
	Content.load({
		url: '/api/stats/getStatsLoanReturnTime'
	});
});