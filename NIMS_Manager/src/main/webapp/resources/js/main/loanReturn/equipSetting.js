$(function() {
	const Content = {
		...
		event: function() {
			...
			$('button[role="export"]').click(function(e){
				...
				let file_name = "대출반납기 장비 설정 목록_("+common.getDateToStr()+").xlsx";
		...
		draw: function() {
			...
			const table = new Tabulator("#settingTable", {
				...
				columns: [
					...
					{ title: "포트번호", field: "com", widthGrow: 1.5, headerSort: false },
					{
						title: "항목 1", field: "value1", widthGrow: 1.5, headerSort: false,
					...
					{
						title: "항목 2", field: "value2", widthGrow: 1.5, headerSort: false,
						formatter: "tickCross", formatter: function(cell, formatterParams, onRendered) {
							let outerText = "";
							cell.getValue() ? outerText = cell.getValue() : outerText = "-";
					...
					{
						title: "항목 3", field: "value3", widthGrow: 1.5, headerSort: false,
						formatter: "tickCross", formatter: function(cell, formatterParams, onRendered) {
							let outerText = "";
							cell.getValue() ? outerText = cell.getValue() : outerText = "-";
					...
					{
						title: "항목 4", field: "value4", widthGrow: 1.5, headerSort: false,
						formatter: "tickCross", formatter: function(cell, formatterParams, onRendered) {
							let outerText = "";
							cell.getValue() ? outerText = cell.getValue() : outerText = "-";
					...
					{
						title: "항목 5", field: "value5", widthGrow: 1.5, headerSort: false,
						formatter: "tickCross", formatter: function(cell, formatterParams, onRendered) {
							let outerText = "";
							cell.getValue() ? outerText = cell.getValue() : outerText = "-";
	...
	Content.load({
		url: '/api/loanReturn/getLoanReturnEquipRuleInfoList'
	});
});