$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					},
					{
						...
						columns:[
							{ title: "건수", field: "return_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center", topCalc:"sum" },
							{ title: "이용자 수", field: "return_user_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center" },
						]
					},
				],
	...
	Content.load({
		url: '/api/stats/getStatsLoanReturnDate'
	});
});