$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					{ title: "장비명", field: "device_nm", widthGrow: 3, hozAlign: "center", headerHozAlign: "center", headerSort: false },
					{
						...
						columns: [
							{ title: "대출 횟수", field: "loan_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
							{ title: "이용자 수 ", field: "loan_user_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					},
					{
						title: "반납 정보", hozAlign: "center", headerHozAlign: "center",
						columns: [
							{ title: "반납 횟수", field: "return_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
							{ title: "이용자 수 ", field: "return_user_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					}
				],
	...
	Content.load({
		url: '/api/stats/getStatsLoanReturnDevice'
	});
});