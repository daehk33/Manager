$(function() {
			...
			const table = new Tabulator("#listTable", {
				...
				ajaxResponse: function(url, params, response) {
					...
					if(response.result.count == 0) {
						...
						table.updateColumnDefinition("status", {headerFilter: false});
						...
						table.updateColumnDefinition("status", {headerFilter: "select"});
				...
				columns: [
					...
					{ title: "대출일", widthGrow: 3, field: "loan_date", headerSort: false },
					{ title: "반납일", widthGrow: 3, field: "return_date", headerSort: false },
					{ title: "반납예정일", widthGrow: 3, field: "return_plan_date", headerSort: false },
					{ title: "도서 상태", widthGrow: 2, field: "status", headerSort: false, headerFilterParams: {values:["대출", "반납"]}, headerFilterPlaceholder: " "},
					{ title: "회원 아이디", widthGrow: 2, field: "user_id", headerSort: false, headerFilterPlaceholder: " " },
					{ title: "회원명", widthGrow: 2, field: "user_name", headerSort: false, headerFilterPlaceholder: " ", formatter:function(cell){return Masking.name(cell.getValue());}}
				],
	...
	Content.load({
		url: '/api/history/getLoanReturnHistoryList'
	});
});