$(function() {
		...
		draw : function () {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					{ title: "권 수", field: "return_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false },
					{ title: "이용인원", field: "return_user_cnt", widthGrow: 4, hozAlign:"center", headerHozAlign: "center", headerSort: false }
				],
	...
	Content.load({
		url: '/api/stats/getStatsReturnDevice'
	});
});