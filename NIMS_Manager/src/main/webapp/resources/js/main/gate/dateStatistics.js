$(function() {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					},
					{
						...
						columns: [
							{ title: "출입 횟수", field: "pass_in_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center", topCalc:"sum"  },
							{ title: "이용자 수", field: "pass_in_user_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center" }
						]
					},
					{
						title:"퇴실 정보" , hozAlign: "center", headerHozAlign: "center",
						columns:[
							{ title: "출입 횟수", field: "pass_out_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center", topCalc:"sum" },
							{ title: "이용자 수", field: "pass_out_user_cnt", widthGrow: 4, headerSort: false, hozAlign: "center", headerHozAlign: "center" },
						]
					}
				],
	...
	Content.load({
		url: '/api/stats/getStatsGateDate'
	});
});