$(function() {
		...
		draw : function () {
			...
			const table = new Tabulator("#statsTable", {
				...
				columns: [
					...
					{ title: "장비명", field: "device_nm", widthGrow: 3, hozAlign: "center", headerHozAlign: "center", headerSort: false },
					{
						title: "입실 정보", hozAlign: "center", headerHozAlign: "center",
						columns: [
							{ title: "출입 횟수", field: "pass_in_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
							{ title: "이용자 수 ", field: "pass_in_user_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					},
					{
						title: "퇴실 정보", hozAlign: "center", headerHozAlign: "center",
						columns: [
							{ title: "출입 횟수", field: "pass_out_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
							{ title: "이용자 수 ", field: "pass_out_user_cnt", widthGrow: 3.5, hozAlign:"center", headerHozAlign: "center", headerSort: false },
						]
					}
				],
	...
	Content.load({
		url: '/api/stats/getStatsGateDevice'
	});
});