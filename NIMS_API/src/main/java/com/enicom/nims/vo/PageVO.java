...
public class PageVO {
	...
	private void makePaging() {
        ...
        if (this.pageSize == 0) this.setPageSize(PAGE_SIZE); //기본 페이지 리스트 사이즈
        if (this.pageBlock == 0 ) this.setPageBlock(PAGE_BLOCK); //기본 페이지 네비[블록] 사이즈
	...
	public String toString() {
		return "PageVO [pageSize=" + pageSize + ", pageBlock=" + pageBlock + ", pageNo=" + pageNo + ", startRowNo="
