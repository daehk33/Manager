...
public class MagicPacket {
	...
	public static String send(String mac, String ip) throws UnknownHostException, SocketException,IOException, IllegalAccessException
	{
		return send(mac, ip, PORT);
	}
	
	public static String send(String mac, String ip, int port) throws UnknownHostException, SocketException, IOException, IllegalAccessException
	{
	...
	public static void main(String[] args) {
		if(args.length != 2) {
			...
			System.out.println("Example: java MagicPacket 192.168.0.255 F4-B5-20-2B-6D-97");
//			System.out.println("Example: java MagicPacket 192.168.0.255 00-0D-61-08-22-4A");
		...
		try	{
			...
			System.out.println("Sending to: "+MagicPacket.send(macStr, ipStr));
		}
